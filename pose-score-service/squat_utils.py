...
from feedbackText import textGeneratorSquat
...
class Squat():
    ...
    def visualize(self):
        ...
        ax[0, 0].title.set_text('Squat Progression (raw)')
        ...
        ax[0, 1].title.set_text('Squat Progression (Best Fit)')
        ...
        txt1, txt2, txt3 = textGeneratorSquat(val_amp, val_minmax, val_time)
